...
public class ElementAndGate extends ElementPodstawa{
	...
	protected void OnButtonPress() {
		...
		int option = JOptionPane.showConfirmDialog(null, panel, "AndGate", JOptionPane.CANCEL_OPTION);
		if(option == JOptionPane.OK_OPTION)
		{
			...
			if(x>-1 && y>-1 && w>0 && h>0)
			{
				DrawAndGate elipse = new DrawAndGate(w,h);
				elipse.SetCords(x, y);
